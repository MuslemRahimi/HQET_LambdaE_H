...
with open("LambdaE_0.85.txt", "r") as data:
	data = data.readlines()
	for i in data:
		M_E_085.append(float(i.split()[0]))
		lambdaE_085.append(float(i.split()[1]))

M_E_085 = np.array(M_E_085)
...
with open("LambdaE_1.0.txt", "r") as data:
	data = data.readlines()
	for i in data:
		M_E_10.append(float(i.split()[0]))
		lambdaE_10.append(float(i.split()[1]))

M_E_10 = np.array(M_E_10)
...
with open("LambdaE_1.15.txt", "r") as data:
	data = data.readlines()
	for i in data:
		M_E_115.append(float(i.split()[0]))
		lambdaE_115.append(float(i.split()[1]))

M_E_115 = np.array(M_E_115)
...
plt.ylim(0.10,0.13)
plt.xlim(0.20,1)
plt.yticks(np.arange(0.10, 0.14, step=0.01))
...
plt.ylim(0.10,0.16)
plt.xlim(0.20,1)
plt.yticks(np.arange(0.10, 0.16, step=0.01))
