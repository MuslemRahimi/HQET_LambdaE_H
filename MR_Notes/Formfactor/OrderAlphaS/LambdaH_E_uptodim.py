...
ax.plot(M_5, lambdaE_5,"--",color='purple',label='up to dim. 5')
ax.plot(M_6, lambdaE_6,"--",color='orange',label='up to dim. 6')
ax.plot(M_7, lambdaE_7,color='black',label='up to dim. 7')
